PRODUCTS = {
    ...
    'блендер': {
        ...
        'material_codes': {
            'прочной нержавеющей стали, что обеспечивает долговечность и высокую эффективность при выполнении различных задач': '',
        },
    },
    'блесна': {
        'code': '9507900000',
    ...
    'лампа': {
        ...
        'aliases': [
            ...
            'светодиодные',
            'lampa',
            'светодиодные платы задних фонарей',
            'уф стерилизатор',
        ],
    },
    'лампа автомобильная': {
    ...
    'чай листовой': {
        ...
        'material_codes': {
            'отборных ферментированных чайных листьев, прошедших не менее 6 лет естественного старения, что придает ему насыщенный аромат, мягкий обволакивающий вкус и глубокий янтарный цвет настоя': '902100009',
        },
    },
    'чайная кофейная': {
        'code': '6912002900',
    ...
    'шарик воздушный': {
        ...
        'material_codes': {
            'прочной фольги, устойчивой к повреждениям': '',
        },
    },
    'шарик для стирки': {
        'code': '3924900009',
